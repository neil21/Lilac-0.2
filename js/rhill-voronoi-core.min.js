...
this.vertices=[];this.edges=[];this.cells=[]};Voronoi.prototype.sqrt=Math.sqrt;Voronoi.prototype.abs=Math.abs;Voronoi.prototype.e=Voronoi.e=1e-9;
Voronoi.prototype.inve=Voronoi.inve=1/Voronoi.e;Voronoi.prototype.equalWithEpsilon=function(d,c){return this.abs(d-c)<1e-9
...
}}e++}n.closeMe=false}};Voronoi.prototype.quantizeSites=function(c){var b=this.e,d=c.length,a;while(d--){a=c[d];a.x=Math.floor(a.x/b)*b;
